...
st.title('About — GovSec AI')
st.markdown('''
**GovSec AI** demonstrates a pragmatic approach to URL-based phishing detection using hand-crafted features and a small ML pipeline.
